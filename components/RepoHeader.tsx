...
const RepoHeader: React.FC<RepoHeaderProps> = ({
  ...
  const repoButtonBg = isPrincess
    ? "bg-pink-100 hover:bg-pink-200 text-pink-900 border-pink-200"
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex items-center min-w-0 z-40">
        ...
        {/* Separator */}
        <span className={`mx-3 text-xs font-medium ${compareText}`}>
          compare to
        </span>
