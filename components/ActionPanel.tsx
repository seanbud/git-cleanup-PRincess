...
const ActionPanel: React.FC<ActionPanelProps> = ({
  ...
  const primaryColorClass = isPrincess
    ? "bg-pink-500 hover:bg-pink-600"
    : "bg-blue-600 hover:bg-blue-700";
  const secondaryColorClass = isPrincess
  ...
  if (selectedCount === 0) {
    return (
      <div
        className={`p-4 border-t border-gray-200 ${emptyBgClass} text-center text-sm text-gray-500 italic transition-colors duration-300`}
      >
  ...
  return (
    <>
      <div
        className={`p-4 border-t border-gray-200 ${bgClass} space-y-3 shadow-lg z-10 transition-colors duration-300`}
      >
