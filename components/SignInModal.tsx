            ...
            <div className="text-center space-y-6">
                ...
                {!authData ? (
                    ...
                    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2">
                        <div className={`p-4 rounded-xl border-2 border-dashed relative group transition-colors ${isPrincess ? 'border-pink-200 bg-pink-50/50' : 'border-slate-700 bg-slate-800/50'}`}>
                            ...
                            <div className="text-3xl font-mono tracking-widest font-bold flex items-center justify-center">
                                ...
                                <button
                                    onClick={handleCopy}
                                    className={`ml-4 p-2 rounded-lg transition-all active:scale-90 ${isPrincess ? 'hover:bg-pink-100 text-pink-500' : 'hover:bg-slate-700 text-blue-400'}`}
