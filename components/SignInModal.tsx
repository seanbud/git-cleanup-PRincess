                        ...
                        <div className={`p-4 rounded-xl border-2 border-dashed relative group ${isPrincess ? 'border-pink-200 bg-pink-50/50' : 'border-slate-700 bg-slate-800/50'}`}>
                            ...
                            <div className="flex items-center justify-center space-x-4">
                                ...
                                <button
                                    ...
                                    className={`p-2 rounded-lg transition-all focus:outline-none focus:ring-2 ${isPrincess
                                            ? 'hover:bg-pink-100 text-pink-600 focus:ring-pink-300 focus:bg-pink-100'
                                            : 'hover:bg-slate-700 text-blue-400 focus:ring-blue-500 focus:bg-slate-700'
                                        }`}
                                >
