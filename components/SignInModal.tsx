                    ...
                    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2">
                        <div className={`p-4 rounded-xl border-2 border-dashed ${isPrincess ? 'border-pink-200 bg-pink-50/50' : 'border-slate-700 bg-slate-800/50'} relative group`}>
                            ...
                            <button
                                ...
                                className={`absolute right-3 top-3 p-2 rounded-md transition-all duration-200 ${isPrincess ? 'hover:bg-pink-100 text-pink-500 focus:bg-pink-100' : 'hover:bg-slate-700 text-blue-400 focus:bg-slate-700'
                                    } ${copied ? 'scale-110' : 'scale-100 opacity-0 group-hover:opacity-100 focus:opacity-100'}`}
                            >
