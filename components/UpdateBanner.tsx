...
const UpdateBanner: React.FC<UpdateBannerProps> = ({ mode }) => {
  ...
  return (
    <div
      className={`${bgColor} text-white ${isWindows ? "pl-4" : ""} ${paddingRight} py-2 flex items-center justify-between text-xs shadow-lg z-[200] relative`}
    >
      <div className="flex items-center gap-2">
        ...
        {state === "downloaded" && <span>Update ready! Restart to apply.</span>}
      </div>
