...
export class GitService {
    ...
    static async getBestComparisonBranch(): Promise<string> {
        // Optimization: Hoist current branch lookup to avoid redundant calls inside loops
    ...
    static async getStatusFiles(comparisonBranch?: string, currentBranchName?: string): Promise<GitFile[]> {
        ...
        // Optimization: Pass current branch name if already fetched to skip redundant CLI call
        ...
        // Optimization: Parallelize all Git commands for status and diffs.
        // This significantly reduces the total refresh time by overlapping I/O.
