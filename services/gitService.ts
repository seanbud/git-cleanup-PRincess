...
export class GitService {
    ...
    static async getStatusFiles(comparisonBranch?: string, currentBranchName?: string): Promise<GitFile[]> {
        ...
        // Parallelize independent git commands to reduce waterfall
        ...
        if (isComparing && diffRes.success && diffRes.stdout.trim()) {
        ...
        if (isComparing && branchStats.success) addStats(branchStats.stdout);
