  ...
  CrossedSwords: ({ className }: { className?: string }) => (
    ...
    >
      ...
      <g opacity="0.2">
        ...
        <path
          d="M20,20 L80,80 L100,100 L100,100 L40,100 L20,20 Z"
          fill="black"
        />
        <path
          d="M80,20 L20,80 L40,100 L100,100 L100,40 L80,20 Z"
          fill="black"
        />
      ...
      <g transform="translate(50,50) rotate(45)">
        ...
        {/* Guard */}
        <path
          d="M-12,15 L12,15 L12,20 L-12,20 Z"
          fill="#f59e0b"
          stroke="#b45309"
          strokeWidth="1"
          rx="2"
        ...
        {/* Blade */}
        <path
          d="M-5,15 L-5,-35 L0,-45 L5,-35 L5,15 Z"
          fill="#e2e8f0"
          stroke="#94a3b8"
          strokeWidth="1"
        />
...
export const getStatusIcon = (status: FileStatus) => {
  switch (status) {
    case FileStatus.ADDED:
      return <Icons.DiffAdded />;
    case FileStatus.DELETED:
      return <Icons.DiffRemoved />;
    case FileStatus.MODIFIED:
      return <Icons.DiffModified />;
    default:
      return <Icons.DiffModified />;
  }
};
