...
export function highlightCode(
  ...
  if (
    !ext ||
    !["ts", "tsx", "js", "jsx", "json", "css", "html"].includes(ext)
  ) {
    return code;
  }
  ...
  if (["ts", "tsx", "js", "jsx"].includes(ext)) {
    ...
    applyRegex(
      /\b(const|let|var|function|return|if|else|for|while|import|from|export|default|class|extends|interface|type|async|await|try|catch|new|this|throw|break|continue|switch|case|default|void|null|undefined|true|false)\b/g,
      colors.keyword,
    );
    applyRegex(
      /\b(string|number|boolean|any|Promise|React|Dispatch|SetStateAction|MouseEvent|RefObject)\b/g,
      colors.type,
    );
